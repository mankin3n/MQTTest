...
class TestDataFactory:
    ...
    def generate_device_data(
        self, device_type: str = None, device_id: str = None, location: str = None
    ) -> Dict[str, Any]:
        """
        ...
        device_data = {
            ...
            "manufacturer": random.choice(
                ["SmartHome Inc.", "IoT Solutions", "ConnectedDevices"]
            ),
    ...
    def generate_telemetry_data(
        self, device_type: str, device_id: str
    ) -> Dict[str, Any]:
        """
        ...
        if device_type == "thermostat":
            ...
            base_telemetry.update({"sensor_type": sensor_type})
    ...
    def generate_automation_rule(
        self, trigger_device_id: str = None, action_device_id: str = None
    ) -> Dict[str, Any]:
        """
